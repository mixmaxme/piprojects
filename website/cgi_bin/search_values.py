...
print('<meta http-equiv="refresh" content = "0; url = http://wordclock/clock_index.html" />')
print('</head>')
print('<body>')
...
#print('<a href="http://wordclock/clock_index.html"><font face="verdana">Return to main site.</font></a>')
print('</body>')
print('</html>')
