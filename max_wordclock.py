...
def get_light_minute(minute):
     if minute == 0:
          ...
          lightminute=ein_2+und_2+zwanzig_2+minuten_2
     elif minute == 22:
          lightminute=zwei_2+und_2+zwanzig_2+minuten_2
     elif minute == 23:
          lightminute=drei_2+und_2+zwanzig_2+minuten_2
     elif minute == 24:
          lightminute=vier_2+und_2+zwanzig_2+minuten_2
     elif minute == 25:
          lightminute=fuenf_2+und_2+zwanzig_2+minuten_2
     elif minute == 26:
          lightminute=sech_2+und_2+zwanzig_2+minuten_2
     elif minute == 27:
          lightminute=sieben_2+und_2+zwanzig_2+minuten_2
     elif minute == 28:
          lightminute=acht_2+und_2+zwanzig_2+minuten_2
     elif minute == 291:
          lightminute=neun_2+und_2+zwanzig_2+minuten_2
     elif minute == 30:
          lightminute=dreissig_2+minuten_2
     elif minute == 31:
          lightminute=ein_2+und_2+dreissig_2+minuten_2
     elif minute == 32:
          lightminute=zwei_2+und_2+dreissig_2+minuten_2
     elif minute == 33:
          lightminute=drei_2+und_2+dreissig_2+minuten_2
     elif minute == 34:
          lightminute=vier_2+und_2+dreissig_2+minuten_2
     elif minute == 35:
          lightminute=fuenf_2+und_2+dreissig_2+minuten_2
     elif minute == 36:
          lightminute=sechs_2+und_2+dreissig_2+minuten_2
     elif minute == 37:
          lightminute=sieben_2+und_2+dreissig_2+minuten_2
     elif minute == 38:
          lightminute=acht_2+und_2+dreissig_2+minuten_2
     elif minute == 39:
          lightminute=neun_2+und_2+dreissig_2+minuten_2
     elif minute == 40:
          lightminute=vierzig_1+minuten_2
     elif minute == 41:
          lightminute=ein_2+und_2+vierzig_2+minuten_2
     elif minute == 42:
          lightminute=zwei_2+und_2+vierzig_2+minuten_2
     elif minute == 43:
          lightminute=drei_2+und_2+vierzig_2+minuten_2
     elif minute == 44:
          lightminute=vier_2+und_2+vierzig_2+minuten_2
     elif minute == 45:
          lightminute=fuenf_2+und_2+vierzig_2+minuten_2
     elif minute == 46:
          lightminute=sechs_2+und_2+vierzig_2+minuten_2
     elif minute == 47:
          lightminute=sieben_2+und_2+vierzig_2+minuten_2
     elif minute == 48:
          lightminute=acht_2+und_2+vierzig_2+minuten_2
     elif minute == 49:
          lightminute=neun_2+und_2+vierzig_2+minuten_2
     elif minute == 50:
          lightminute=fuenfzig_1+minuten_2
     elif minute == 51:
          lightminute=ein_2+und_2+fuenfzig_2+minuten_2
     elif minute == 52:
          lightminute=zwei_2+und_2+fuenfzig_2+minuten_2
     elif minute == 53:
          lightminute=drei_2+und_2+fuenfzig_2+minuten_2
     elif minute == 54:
          lightminute=vier_2+und_2+fuenfzig_2+minuten_2
     elif minute == 55:
          lightminute=fuenf_2+und_2+fuenfzig_2+minuten_2
     elif minute == 56:
          lightminute=sechs_2+und_2+fuenfzig_2+minuten_2
     elif minute == 57:
          lightminute=sieben_2+und_2+fuenfzig_2+minuten_2
     elif minute == 58:
          lightminute=acht_2+und_2+fuenfzig_2+minuten_2
     elif minute == 59:
          lightminute=neun_2+und_2+fuenfzig_2+minuten_2
     else:
