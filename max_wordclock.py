...
def get_light_minute(minute):
     if minute == 0:
          ...
          lightminute=zwanzig_2+minuten_2
     elif minute == 21:
          lightminute=ein_4+und_3+zwanzig_2+minuten_2
     elif minute == 22:
          ...
          lightminute=ein_4+und_3+dreissig_2+minuten_2
     elif minute == 32:
          ...
          lightminute=vierzig_2+minuten_2
     elif minute == 41:
          lightminute=ein_4+und_3+vierzig_2+minuten_2
     elif minute == 42:
          ...
          lightminute=fuenfzig_2+minuten_2
     elif minute == 51:
          lightminute=ein_4+und_3+fuenfzig_2+minuten_2
     elif minute == 52:
